...
-- Schema EQUIPOS
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `EQUIPOS` ;
-- -----------------------------------------------------
-- Schema HISTORIAN
-- -----------------------------------------------------
...
-- Schema ALINEACION
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ALINEACION` ;
-- -----------------------------------------------------
-- Schema LABORATORIO
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `EQUIPOS`.`Equipo` (
  `tagEquipo` VARCHAR(45) NOT NULL,
  `nombre` VARCHAR(45) NULL,
  `claseEquipo` VARCHAR(45) NOT NULL,
  `area` INT NOT NULL,
  PRIMARY KEY (`tagEquipo`),
  UNIQUE INDEX `tagEquipo_UNIQUE` (`tagEquipo` ASC) VISIBLE,
  INDEX `fk_Equipo_Area_idx` (`area` ASC) VISIBLE,
  INDEX `fk_Equipo_ClaseEquipo1_idx` (`claseEquipo` ASC) VISIBLE,
  CONSTRAINT `fk_Equipo_Area`
    FOREIGN KEY (`area`)
    REFERENCES `EQUIPOS`.`Area` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Equipo_ClaseEquipo1`
    FOREIGN KEY (`claseEquipo`)
...
CREATE TABLE IF NOT EXISTS `EQUIPOS`.`Sensor` (
  ...
  UNIQUE INDEX `tagSensor_UNIQUE` (`tagSensor` ASC) VISIBLE,
  INDEX `fk_Sensor_Equipo1_idx` (`tagEquipo` ASC) VISIBLE,
  CONSTRAINT `fk_Sensor_Equipo1`
    FOREIGN KEY (`tagEquipo`)
    REFERENCES `EQUIPOS`.`Equipo` (`tagEquipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `EQUIPOS`.`PuntoMuestra` (
  `idPuntoMuestra` VARCHAR(45) NOT NULL,
  `tagEquipo` VARCHAR(45) NOT NULL,
  `nombre` VARCHAR(45) NULL,
  PRIMARY KEY (`idPuntoMuestra`),
  UNIQUE INDEX `nombre_UNIQUE` (`nombre` ASC) VISIBLE,
  INDEX `fk_PuntoMuestra_Equipo1_idx` (`tagEquipo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `LABORATORIO`.`ResultadoAnalisis` (
  `idMuestra` VARCHAR(45) NOT NULL,
  `idAnalisis` VARCHAR(45) NOT NULL,
  `rutAnalista` VARCHAR(10) NOT NULL,
  `resultado` DECIMAL(7,2) NULL,
  PRIMARY KEY (`idMuestra`, `idAnalisis`),
  ...
  CONSTRAINT `fk_ResultadoAnalisis_Muestra1`
